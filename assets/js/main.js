...
function scrollHeader(){
    ...
    if(this.scrollv >= 200) header.classList.add('scroll-header'); else header.classList.remove('scroll-header')
}
...
function scrollTop(){
    ...
    if(this.scrollv >= 560) scrollTop.classList.add('show-scroll'); else scrollTop.classList.remove('show-scroll')
}
